(function () {
  ...
  var REFERENCE = {
    ...
    paragraphs: [
      ...
      "Оценка проводится у всех пациентов с указанными ниже состояниями, при первичном осмотре, после введения обезболивающих и при динамическом наблюдении."
    ],
    importantNote: "Оценка боли субъективна. У детей, пожилых и пациентов с когнитивными нарушениями предпочтительнее использовать шкалу лиц Wong-Baker или упрощённые вербальные шкалы.",
    // Показания к обязательной оценке — из эталона
    indications: [
      "Злокачественные новообразования",
      "Болезни периферической нервной системы и межпозвонковых дисков",
      "Черепно-мозговая травма (сотрясение, ушиб, переломы костей черепа, ЧМТ)",
      "Перелом позвоночника, вывих шейного позвонка",
      "Вывихи конечностей (плечо, предплечье, кисть, голень, стопа, суставы)",
      "Закрытые и открытые переломы костей конечностей",
      "Травмы грудной клетки, открытые раны, синдром длительного сдавления",
      "Открытая травма живота, травма наружных половых органов",
      "Термические и химические ожоги, отморожения",
      "Боли «под гипсом» — обязательный критерий (риск компартмент-синдрома)"
    ]
  };
  ...
  // ===== Кнопка сброса внутри плашки результата =====
  ...
  function init() {
    ...
    // Сброс — кнопка-символ на плашке результата
  ...
  CU.autoPersist("smp-calc-vas-v1");
})();